...
/* harmony import */ var _functions_sliders__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./functions/sliders */ "./src/js/functions/sliders.js");
/* harmony import */ var _functions_images_modal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./functions/images-modal */ "./src/js/functions/images-modal.js");
/* harmony import */ var _functions_send_form_info__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./functions/send-form-info */ "./src/js/functions/send-form-info.js");
/* harmony import */ var _functions_mask__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./functions/mask */ "./src/js/functions/mask.js");
/* harmony import */ var aos__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! aos */ "./node_modules/aos/dist/aos.js");
/* harmony import */ var aos__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(aos__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _functions_add_attributes__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./functions/add-attributes */ "./src/js/functions/add-attributes.js");
...
(0,_functions_images_modal__WEBPACK_IMPORTED_MODULE_2__.imageModal)();

// Для работы с формами


(0,_functions_mask__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="phone"]');
...
(0,_functions_add_attributes__WEBPACK_IMPORTED_MODULE_6__["default"])();
...
/***/ "./src/js/functions/add-attributes.js":
/*!********************************************!*\
  !*** ./src/js/functions/add-attributes.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const addAttributes = () => {
  var _document;
  const list = (_document = document) === null || _document === void 0 ? void 0 : _document.querySelectorAll("[data-aos");
...
(function () {
  ...
  burger === null || burger === void 0 ? void 0 : burger.addEventListener("click", e => {
    burger === null || burger === void 0 ? void 0 : burger.classList.toggle("header__burger--active");
...
/***/ "./src/js/functions/images-modal.js":
/*!******************************************!*\
  !*** ./src/js/functions/images-modal.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const imageModal = () => {
  ...
  document.querySelector(".reviews-slider").addEventListener("click", event => {
    if (!event || !event.target) return;
    event.preventDefault();
    let resultImage;
    document.querySelectorAll(".reviews-slider .slick-slide img").forEach(image => {
    ...
    modal.addEventListener("click", event => {
      ...
      if (event.target && (event.target === closeButton || event.target === modal)) {
...
/***/ "./src/js/functions/send-form-info.js":
/*!********************************************!*\
  !*** ./src/js/functions/send-form-info.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()("#form").on("submit", function (e) {
  ...
  let name = (_document = document) === null || _document === void 0 ? void 0 : _document.querySelector('[name="name"]'),
    phone = (_document2 = document) === null || _document2 === void 0 ? void 0 : _document2.querySelector('[name="phone"]'),
    telegram = (_document3 = document) === null || _document3 === void 0 ? void 0 : _document3.querySelector('[name="telegram"]');
  const message = `
   <b>ФИ: ${name.value}</b>
  <b>Номер телефона: ${phone.value}</b>
  <b>Telegram: @${telegram.value[0] === "@" ? telegram.value.slice(1, -1) : telegram.value}</b>`;
  const request = jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax(URI_API, {
    type: "POST",
    data: {
      chat_id: CHAT_ID,
      parse_mode: "html",
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".success-slick-image").slick({
    slidesToShow: 1,
    slidesToScroll: 1,
    speed: 300,
    arrows: false,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".success-slick-slider").slick({
    slidesToShow: 5,
    slidesToScroll: 1,
    infinite: true,
    speed: 300,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".reviews-slider").slick({
    infinite: false,
    speed: 300,
    slidesToShow: 4,
    slidesToScroll: 4,
